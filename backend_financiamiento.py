...
TABLA_PERMITIDA = "financiamiento"
...
La base de datos tiene una única tabla llamada 'financiamiento' con una columna llamada 'content'.
Solo debes generar consultas SELECT válidas y seguras sobre la tabla 'financiamiento' y la columna 'content'.
...
# Función para obtener todos los contenidos de la tabla 'financiamiento'
def obtener_todos_los_contenidos(conn):
    try:
        cursor = conn.cursor()
        cursor.execute("SELECT content FROM financiamiento;")
